      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <a
              href="/specifications/spec_v7.html"
              target="_blank"
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          onClick={() => {
            ...
            if (!testResult && !isTestingApi) {
              handleRunApiTest();
            }
          }}
          className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-purple-50 dark:bg-purple-950/40 border border-purple-300 dark:border-purple-800 hover:border-purple-500 text-xs font-bold text-purple-700 dark:text-purple-300 shadow-sm transition-all"
        >
        ...
        <button
          ...
          className="hidden sm:flex items-center gap-2 px-3 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-[#4285F4] text-xs text-slate-700 dark:text-slate-300 transition-colors"
        >
          <Sparkles className="w-3.5 h-3.5 text-[#4285F4]" />
          <span>
            Model: <strong className="text-slate-900 dark:text-white">Gemini Nano Banana</strong>
          </span>
        ...
        <button
          ...
          className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700 text-xs font-semibold text-slate-700 dark:text-slate-300 transition-colors shadow-sm"
        >
        ...
        <button
          ...
          className="p-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors shadow-sm"
        ...
        <button
          onClick={() => setShowKeyModal(true)}
          className="flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-semibold border transition-colors shadow-sm bg-emerald-50 dark:bg-emerald-950/60 border-emerald-300 dark:border-emerald-800 text-emerald-700 dark:text-emerald-300"
        >
